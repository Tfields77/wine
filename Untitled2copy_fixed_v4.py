...
# Try to import scikit-learn modules; if not found, install them using the --user flag.
try:
    from sklearn.preprocessing import OneHotEncoder
    from sklearn.feature_extraction.text import TfidfVectorizer
    from sklearn.metrics.pairwise import cosine_similarity
except ModuleNotFoundError:
    st.warning("scikit-learn not found. Installing scikit-learn using --user flag...")
...
# Loop through the dataset in chunks and compute recommendations
recommendations = []
current_chunk = 0
